    ...
    fetch('https://form.temptestsites.online/candidates.csv', {
        ...
        .catch(err => {
            document
                ...
                .appendChild(
                    document.createTextNode(`Something has gone wrong: ${err}`)
                )
        })
        .then(candidateData => {
          ...
          <p>
        <div class="line">
          <label for="candidate-${idx}" id="candidate-${idx}-label" class="label-container">${
                        candidate.name
                    }
            <input type="radio" id="candidate-${idx}" name="winner" value="${
                        candidate.name
                    }">
